...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "paul-jean-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/rule146"
  #   chef.validation_client_name = "rule146-validator"
  #   chef.validation_key_path = ".chef/rule146-validator.pem"
  # end
end
